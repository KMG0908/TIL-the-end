  ...
  render() {
    return (
      <>
        ...
        <div align="center">
          <Button variant="contained" onClick={() => { this.setHeatMap(2020) }}>2020</Button>
          <Button variant="contained" onClick={() => { this.setHeatMap(new Date('december 31 2019')) }}> 2019 </Button>
          <Button variant="contained" onClick={() => { this.setHeatMap(new Date('december 31 2018')) }}> 2018 </Button>
        </div>
        <Heatmap user_id={this.state.user_id} onHandleDate={this.onHandleDate} cur_date={this.state.cur_date}></Heatmap>
