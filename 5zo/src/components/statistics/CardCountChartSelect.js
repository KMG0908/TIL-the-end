...
const startDate = '2019-02-04'.split('-');
const endDate = '2020-01-07'.split('-');
const dates = ['2019-02-04', '2019-02-26', '2019-05-02', '2019-08-05', '2020-01-05', '2020-01-06', '2020-01-07']
const dailyTask = [2, 2, 5, 1, 5, 4, 3]
// const startDate = '2019-02-04'.split('-');
// const endDate = '2019-08-21'.split('-');
// const dates = ['2019-02-04', '2019-02-26', '2019-05-02', '2019-05-12', '2019-06-19', '2019-07-02', '2019-08-05']
// const dailyTask = [2, 2, 5, 1, 5, 4, 3]
    ...
    events: {
      ...
      drillup: function(e) {
        if(e.seriesOptions.id == null || e.seriesOptions.id.substr(0, 3) === "y_m"){
          this.setTitle({ text: startDate[0] + "-" + startDate[1] + "-" + startDate[2] + " ~ " + endDate[0] + "-" + endDate[1] + "-" + endDate[2] })
        }
        else {
          this.setTitle({ text: e.seriesOptions.id.substr(4) + "년" });
        }
