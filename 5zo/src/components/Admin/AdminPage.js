...
class AdminPage extends Component {
    ...
    render() {
        ...
        console.log('admin page memberLists')
        ...
        return (
            <>
                ...
                <br />
                <div style={{ position: "relative", textAlign: "center" }}>
                    <div key={`${query.keyword}${query.limit}${query.page}`} style={{ display: 'inline-block', width: widthPer }}>
                        {this.props.memberList ? this.props.memberList.map(member => <MemberCard member={member}></MemberCard>) : null}
                    </div>
                </div>
            </>
        );
