...
import { editMyinfoErrReset, memInfoChangeReset, editMyProfile, setLoggedInfo } from "actions";
...
class MyProfile extends Component {
  ...
  editMyinfo() {
    ...
    this.props.editMyProfile(this.props.mem_info.mem_id, this.state.nick, this.state.intro, this.state.checked, this.state.color, this.state.croppedImageUrl);
  }
  cancelEditMyinfo = () => {
    history.push("/mypage")
  }
...
export default connect(mapStatetoProps, { editMyProfile, editMyinfoErrReset, memInfoChangeReset, setLoggedInfo })(MyProfile);
